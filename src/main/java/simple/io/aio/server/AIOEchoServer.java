...
public class AIOEchoServer {
    ...
    private AIOEchoServer() {
        try {
            ...
            server = AsynchronousServerSocketChannel.open().bind(new InetSocketAddress(SocketConfig.DOMAIN, SocketConfig.PORT));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start() {
        System.out.println("Server listen on " + SocketConfig.PORT);
